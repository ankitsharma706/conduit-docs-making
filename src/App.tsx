    ...
    <div className="group relative my-4">
      <div className="absolute top-0 right-0 p-2 z-10">
        <button 
          ...
          className="p-1.5 rounded-md bg-white/5 border border-white/10 text-white/50 hover:text-white hover:bg-white/10 transition-all font-sans"
        >
          {copied ? <Check className="w-3.5 h-3.5 text-mint-success" /> : <Copy className="w-3.5 h-3.5" />}
        </button>
      </div>
      <pre className="!bg-navy-900 border border-white/5 rounded-xl p-4 overflow-x-auto text-sm font-mono scrollbar-thin scrollbar-thumb-white/10">
        <code 
...
const EndpointModule = ({ 
  ...
  <div className="py-8 border-b border-white/5 last:border-0">
    <div className="flex items-center gap-3 mb-4">
      ...
      <code className="text-white font-mono text-sm font-semibold tracking-tight">{path}</code>
    </div>
...
const OverviewSection = ({ onNavigate }: { onNavigate: (id: string) => void }) => (
  <section className="space-y-12">
    <header className="space-y-4">
      ...
      <div className="flex border-y border-white/5 py-8 mt-8">
        {[
          { label: 'Avg Detection Latency', val: '< 800ms' },
          { label: 'Revenue Protected (Q2)', val: '₹2.4B+' },
          { label: 'Platform Uptime SLA', val: '99.97%' },
        ].map((stat, i) => (
          <div key={i} className="flex-1 text-center border-r last:border-0 border-white/5">
            <div className="text-2xl font-mono font-bold text-white mb-1">{stat.val}</div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {[
        ...
        <button 
          ...
          className="text-left p-6 rounded-2xl bg-navy-900 border border-white/5 hover:border-indigo-accent/50 hover:bg-navy-800 transition-all group"
        >
    ...
    <div className="space-y-12">
      <h2 className="text-2xl font-bold text-white border-b border-white/5 pb-4">Key Concepts</h2>
...
const ConceptsSection = () => (
  <section className="space-y-12">
    <header className="space-y-4">
      ...
      <h1 className="text-4xl font-extrabold tracking-tight text-white mb-2">Core Concepts</h1>
      <p className="text-lg text-text-secondary">A deep dive into the Conduit data model and architecture.</p>
    </header>

    <div className="space-y-10">
      <div className="p-8 rounded-2xl bg-navy-900 border border-white/5">
        <h3 className="text-xl font-bold text-white mb-4">1. The Conduit Data Model</h3>
        ...
        <div className="bg-black/40 p-4 rounded-xl border border-white/5 font-mono text-xs text-indigo-accent/80 leading-relaxed overflow-x-auto whitespace-pre">
...
OUTCOME TRACKING (Protected Revenue)`}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="p-6 rounded-2xl bg-navy-900 border border-white/5">
          <h4 className="text-white font-bold mb-3">Metric Collection</h4>
        ...
        <div className="p-6 rounded-2xl bg-navy-900 border border-white/5 border-l-4 border-l-red-danger">
          <h4 className="text-white font-bold mb-3">Severity: P1 vs P2</h4>
          <p className="text-sm text-text-secondary leading-relaxed">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-bold text-white">Partner Graph & Blast Radius</h3>
        <p className="text-text-secondary leading-relaxed">
          Directed dependency map: <span className="text-white italic">Rail → Aggregator → Bank → Merchant</span>. Nodes turn red when health drops, showing immediate downstream blast radius calculated as sum of AUM_at_risk.
        </p>
      </div>
    </div>
  </section>
...
const QuickstartSection = () => (
  <section className="space-y-12">
    <div>
      <h1 className="text-4xl font-extrabold tracking-tight text-white mb-2">Quickstart</h1>
    ...
    <div className="space-y-12">
      {[
        ...
        <div key={i} className="relative pl-12 group">
          <div className="absolute left-0 top-0 w-8 h-8 rounded-full border border-indigo-accent/30 flex items-center justify-center text-xs font-bold text-indigo-accent bg-indigo-accent/5 group-hover:bg-indigo-accent group-hover:text-white transition-all">
            {step.step}
          </div>
...
const AuthSection = () => (
  <section className="space-y-8">
    <div>
      <h1 className="text-4xl font-extrabold tracking-tight text-white mb-2">Authentication</h1>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      {[
        ...
        <div key={i} className="p-5 rounded-xl bg-navy-900 border border-white/5">
    ...
    <div className="overflow-x-auto">
      <table className="w-full text-left text-sm border-collapse">
        <thead>
          <tr className="border-b border-white/10 text-text-secondary uppercase text-[10px] tracking-widest">
        ...
        <tbody className="text-text-primary/90">
          <tr className="border-b border-white/5 bg-white/0 hover:bg-white/[0.02] transition-colors">
    ...
    <div>
      ...
      <div className="flex flex-wrap gap-2">
        {['incidents:read', 'autofix:execute', 'revenue:read', 'partners:read'].map(scope => (
          <code key={scope} className="px-2 py-1 bg-white/5 border border-white/10 rounded text-xs text-indigo-accent">
            {scope}
          </code>
        ))}
      </div>
...
const DashboardSection = () => (
  <section className="space-y-8">
    <div>
      <h1 className="text-4xl font-extrabold tracking-tight text-white mb-2">Dashboard APIs</h1>
...
const IncidentSection = () => (
  <section className="space-y-8">
    <div>
      <h1 className="text-4xl font-extrabold tracking-tight text-white mb-2">Incident APIs</h1>
  ...
  "data": {
    ...
    <Callout type="danger" title="Approval required">
      P1 incidents require an explicit <code className="text-white">autofix:approve</code> scope for non-dry-run executions.
    </Callout>
  </section>
);
...
const RevenueSection = () => (
  <section className="space-y-8">
    <div>
      <h1 className="text-4xl font-extrabold tracking-tight text-white mb-2">Revenue APIs</h1>
...
const AISection = () => (
  <section className="space-y-8">
    <div>
      <h1 className="text-4xl font-extrabold tracking-tight text-white mb-2">AI & Prediction APIs</h1>
  ...
  "recommended_action": "Early fail-over to ICICI"
    ...
    <div className="p-6 rounded-2xl bg-navy-900 border border-white/5 space-y-4">
...
const PartnersSection = () => (
  <section className="space-y-8">
    <div>
      <h1 className="text-4xl font-extrabold tracking-tight text-white mb-2">Partner APIs</h1>
...
const WebhookSection = () => (
  ...
  "secret": "whsec_..."
    ...
    <div className="space-y-6">
      <h3 className="text-lg font-bold text-white">Event Examples</h3>
...
const RealtimeSection = () => (
  <section className="space-y-8">
    <div>
      <h1 className="text-4xl font-extrabold tracking-tight text-white mb-2">Real-Time (WebSocket)</h1>
  ...
  "auth_token": "bearer_..."
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      {['latency_update', 'prediction_update', 'incident_triggered'].map(type => (
        <div key={type} className="p-4 bg-navy-900 border border-white/5 rounded-xl">
          <div className="text-[10px] uppercase tracking-widest text-text-secondary mb-1">Event Type</div>
          <div className="text-white font-mono text-sm">{type}</div>
        </div>
      ))}
    </div>
...
const FlowsSection = () => {
  ...
  return (
    <section className="space-y-12">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          <h1 className="text-4xl font-extrabold tracking-tight text-white mb-2">Fintech Flows</h1>
        ...
        <div className="flex bg-navy-900/50 p-1 rounded-xl border border-white/5 self-start">
        ...
        {activeFlow === 'upi' && (
          <div className="space-y-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-3xl font-bold text-white">UPI Payment Flow</h2>
                </div>
              ...
              <div className="flex gap-4">
                <div className="text-right">
                  ...
                  <div className="text-white font-mono text-lg">99.95%</div>
                </div>
                <div className="text-right">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="space-y-6">
                <h4 className="text-xs font-bold uppercase tracking-widest text-text-secondary/50 pb-2 border-b border-white/5">Sequence Visualizer</h4>
                  ...
                  {[
                    ...
                    <div key={i} className="relative">
                      ...
                      <div className="space-y-1">
                        <div className="text-white font-bold text-sm">{step.s}</div>
              ...
              <div className="space-y-6">
                <h4 className="text-xs font-bold uppercase tracking-widest text-text-secondary/50 pb-2 border-b border-white/5">Failure Analysis (U67)</h4>
                <CodeBlock code={`{
  "rail": "upi",
  "status": "FAILED",
  "error": {
    ...
    "repro_step": "High concurrency at Issuer Bank"
        ...
        {activeFlow === 'sip' && (
          <div className="space-y-8">
            <div className="space-y-2">
              <h2 className="text-3xl font-bold text-white">SIP Mandate Flow</h2>
              <p className="text-text-secondary leading-relaxed max-w-2xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="space-y-6">
                <h4 className="text-xs font-bold uppercase tracking-widest text-text-secondary/50 pb-2 border-b border-white/5">Critical Data Gaps</h4>
                <div className="grid grid-cols-1 gap-3">
                  {[
                    ...
                    <div key={i} className={cn("p-4 rounded-xl border flex items-center justify-between", item.bg, item.border)}>
                      ...
                      <span className={cn("text-[10px] font-bold uppercase tracking-widest px-2 py-1 bg-white/5 rounded", item.color)}>
                        {item.val}
                      </span>
                    </div>
                  ))}
              ...
              <div className="space-y-6">
                <h4 className="text-xs font-bold uppercase tracking-widest text-text-secondary/50 pb-2 border-b border-white/5">Mandate Failure Event</h4>
                <CodeBlock code={`{
  "rail": "sip_mandate",
  "type": "e_mandate_auth",
  "result": "DROPPED",
  ...
  "abandoned": true
        ...
        {activeFlow === 'aa' && (
          <div className="space-y-8">
            <div className="space-y-2">
              <h2 className="text-3xl font-bold text-white">Account Aggregator (AA) Flow</h2>
              <p className="text-text-secondary leading-relaxed max-w-2xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2 p-8 rounded-2xl bg-white/5 border border-white/10 relative overflow-hidden group">
                ...
                <div className="relative z-10 space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="text-xl font-bold text-white">Compliance Guard</h4>
                      ...
                      <div className="space-y-3">
                        {[
                          ...
                          <div key={i} className="flex items-center justify-between p-2 bg-black/20 rounded-lg border border-white/5">
                            ...
                            <div className="flex items-center gap-3">
                              <span className={cn("text-[9px] font-bold text-white px-1.5 py-0.5 rounded", cons.status === 'Healthy' ? "bg-mint-success/20" : "bg-amber-warning/20")}>{cons.status}</span>
  ...
  "compliance_score": 1.0
              ...
              <div className="space-y-6">
                <div className="p-6 rounded-2xl bg-navy-900 border border-white/5 border-l-4 border-l-indigo-accent">
                  <h4 className="text-white font-bold mb-2">Consent Conversion</h4>
                  <div className="text-3xl font-extrabold text-white mb-4">78.4%</div>
                ...
                <div className="p-6 rounded-2xl bg-navy-900 border border-white/5">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-xs font-mono text-white">4.2s</span>
                    </div>
                    <div className="flex justify-between items-center">
...
const ErrorsSection = () => (
  <section className="space-y-12">
    <div>
      <h1 className="text-4xl font-extrabold tracking-tight text-white mb-2">Errors & Status Codes</h1>
      ...
      <table className="w-full text-left text-sm border-collapse">
        ...
        <tbody className="text-text-primary/90">
          {[
            ...
            <tr key={i} className="border-b border-white/5 bg-white/0 hover:bg-white/[0.02] transition-colors">
...
const ModelsSection = () => (
  <section className="space-y-12">
    <div>
      <h1 className="text-4xl font-extrabold tracking-tight text-white mb-2">Data Models</h1>
    ...
    {[
      ...
      <div key={i}>
        <h3 className="text-lg font-bold text-white mb-4 lowercase tracking-tight"><span className="text-indigo-accent opacity-50">type</span> {model.title}</h3>
...
const ConventionsSection = () => (
  <section className="space-y-12">
    <div>
      <h1 className="text-4xl font-extrabold tracking-tight text-white mb-2">Conventions</h1>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-bold text-white">Idempotency</h3>
        <p className="text-sm text-text-secondary">Conduit supports idempotency for all <code className="text-white">POST</code> requests. Pass a unique UUID in the <code className="text-indigo-accent">Idempotency-Key</code> header.</p>
      </div>
    </div>

    <div className="space-y-6">
      <h3 className="text-lg font-bold text-white">Unified Response Envelope</h3>
      <CodeBlock code={`{
  "request_id": "req_01HZXK...",
  "data": { ... },
...
const ComplianceSection = () => (
  <section className="space-y-8">
    <div>
      <h1 className="text-4xl font-extrabold tracking-tight text-white mb-2">Compliance APIs</h1>
...
const ChangelogSection = () => (
  <section className="space-y-12">
    <div>
      <h1 className="text-4xl font-extrabold tracking-tight text-white mb-2">Changelog</h1>
...
const OAuthSection = () => (
  <section className="space-y-12">
    <header className="space-y-4">
      ...
      <h1 className="text-4xl font-extrabold tracking-tight text-white mb-2">OAuth 2.0</h1>
      <p className="text-lg text-text-secondary">Conduit uses standard OAuth 2.0 flows for partner-delegated access.</p>
    </header>

    <div className="space-y-8">
      <div className="p-6 rounded-2xl bg-navy-900 border border-white/5">
        <h3 className="text-lg font-bold text-white mb-4">Authorization Code Flow</h3>
...
const ScopesSection = () => (
  <section className="space-y-12">
    <header className="space-y-4">
      ...
      <h1 className="text-4xl font-extrabold tracking-tight text-white mb-2">Scopes & Permissions</h1>
...
const RateLimitsSection = () => (
  <section className="space-y-12">
    <header className="space-y-4">
      <h1 className="text-4xl font-extrabold tracking-tight text-white mb-2">Rate Limits</h1>
      <p className="text-text-secondary leading-relaxed">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="p-6 rounded-2xl bg-navy-900 border border-white/5">
        <h4 className="text-white font-bold mb-4">Response Headers</h4>
        <div className="space-y-3">
          ...
          <div className="flex justify-between border-b border-white/5 pb-2">
            ...
            <span className="text-xs text-white">598</span>
          </div>
          <div className="flex justify-between">
            <span className="text-xs font-mono text-pink-400">Retry-After</span>
            <span className="text-xs text-white">45s</span>
          </div>
        </div>
      </div>
      <div className="p-6 rounded-2xl bg-navy-900 border border-white/5">
        <h4 className="text-white font-bold mb-4">Default Quotas</h4>
        <ul className="space-y-2 text-sm text-text-secondary">
          <li>• <strong className="text-white">Sandbox:</strong> 100 requests / min</li>
          <li>• <strong className="text-white">Production:</strong> 5,000 requests / min</li>
          <li>• <strong className="text-white">Webhook Delivery:</strong> Concurrent delivery up to 50</li>
        </ul>
      </div>
    </div>
  </section>
...
const IdempotencySection = () => (
  <section className="space-y-12">
    <div>
      <h1 className="text-4xl font-extrabold tracking-tight text-white mb-2">Idempotency</h1>
      <p className="text-text-secondary">Safely retry requests without creating duplicate actions.</p>
    </div>

    <p className="text-text-secondary leading-relaxed">
      Conduit supports idempotency for all <code className="text-white">POST</code> requests. This is particularly critical for financial flows and auto-fix executions where a duplicate call could lead to incorrect remediation.
    </p>

    <div className="p-6 border-l-4 border-indigo-accent bg-indigo-accent/5 rounded-r-2xl">
      <div className="text-sm font-bold text-white mb-2 uppercase tracking-widest">Usage</div>
      <p className="text-sm text-text-secondary leading-relaxed">
        Pass a unique string (we recommend a UUID v4) in the <code className="text-white">Idempotency-Key</code> header. Conduit stores these keys for 24 hours.
      </p>
    </div>
...
const SandboxSection = () => (
  <section className="space-y-12">
    <header className="space-y-4">
      <h1 className="text-4xl font-extrabold tracking-tight text-white mb-2">Sandbox & Testing</h1>
    ...
    <div className="space-y-10">
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-bold text-white">Triggering Synthetic Alerts</h3>
...
export default function App() {
  ...
  return (
    <div className="flex min-h-screen selection:bg-indigo-accent/30 selection:text-white">
      {/* Sidebar - Desktop */}
      <aside className="hidden md:flex flex-col w-[280px] fixed top-0 bottom-0 border-r border-white/5 bg-navy-950/50 backdrop-blur-xl z-20">
        <div className="p-6 flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-indigo-accent flex items-center justify-center text-navy-950">
            <Hexagon className="w-5 h-5 fill-current" />
          </div>
          <span className="text-xl font-bold tracking-tight text-white">Conduit</span>
        </div>
        ...
        <div className="px-6 mb-8">
          <button 
            ...
            className="w-full h-10 px-3 rounded-lg bg-white/5 border border-white/10 flex items-center justify-between text-text-secondary hover:bg-white/10 hover:text-white transition-all group"
          >
            <div className="flex items-center gap-2 text-sm">
              <Search className="w-4 h-4 group-hover:scale-110 transition-transform" />
              <span>Search...</span>
            </div>
            <div className="text-[10px] font-bold border border-white/10 px-1.5 py-0.5 rounded bg-white/5" aria-hidden="true">⌘K</div>
          </button>
        </div>
                ...
                {section.items.map((item) => (
                  <li key={item.id}>
                    ...
                    >
                      ...
                      {item.icon && <span className={cn(activeSection === item.id ? "text-indigo-accent" : "text-text-secondary group-hover:text-white")}>{item.icon}</span>}
                      {item.label}
                    </button>
                  </li>
                ))}
      ...
      <main className="flex-1 md:ml-[280px]">
        {/* Sticky Header */}
        <header className="sticky top-0 h-16 border-b border-white/5 bg-navy-950/80 backdrop-blur-md z-10 px-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <button 
          ...
          <div className="flex items-center gap-4">
            <a href="#" className="p-2 text-text-secondary hover:text-white transition-colors">
        ...
        <article className="max-w-4xl mx-auto px-6 md:px-12 py-16">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              transition={{ duration: 0.3, ease: [0.23, 1, 0.32, 1] }}
            >
              <RenderedContent onNavigate={setActiveSection} />
              ...
              <footer className="mt-24 pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div className="flex gap-4">
                  {['Privacy', 'Status', 'Twitter', 'Support'].map(link => (
                    <a key={link} href="#" className="text-xs text-text-secondary hover:text-white transition-colors uppercase tracking-widest font-bold">
                      {link}
                    </a>
                  ))}
                </div>
        ...
        <aside className="hidden xl:block fixed right-8 top-32 w-64 p-6 border-l border-white/5">
          ...
          <ul className="space-y-3">
            {['Overview', 'Parameters', 'Endpoints', 'Examples'].map(anchor => (
              <li key={anchor}>
                <a href={`#${anchor.toLowerCase()}`} className="text-xs text-text-secondary hover:text-white transition-all border-l border-transparent hover:border-indigo-accent pl-2 block">
                  {anchor}
                </a>
              </li>
            ))}
            ...
            >
              <div className="p-4 border-b border-white/5 flex items-center gap-3">
                ...
                <input 
                  ...
                  className="bg-transparent border-none outline-none text-white w-full placeholder:text-text-secondary/30"
                  aria-autocomplete="list"
                  aria-controls="search-results"
                />
                <button 
                  onClick={() => setSearchOpen(false)}
                  className="p-1 rounded bg-white/5 text-[10px] uppercase font-bold text-text-secondary"
                  ...
                  {recentSearches.map((res, i) => (
                    <div 
                      ...
                      className={cn(
                        ...
                        selectedIndex === i ? "bg-white/10 border-white/10" : "hover:bg-white/5 hover:border-white/5"
                      )}
                      role="option"
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span className={cn("text-sm transition-colors", selectedIndex === i ? "text-white" : "text-text-secondary group-hover:text-white")}>{res}</span>
                      </div>
              ...
              <div className="p-3 bg-black/20 border-t border-white/5 flex items-center gap-6" aria-hidden="true">
                <div className="flex items-center gap-2 text-[10px] font-bold text-text-secondary/30">
                  <span className="p-1 bg-white/5 border border-white/10 rounded text-text-secondary">↵</span>
                  <span>Select</span>
                </div>
                <div className="flex items-center gap-2 text-[10px] font-bold text-text-secondary/30">
                  <span className="p-1 bg-white/5 border border-white/10 rounded text-text-secondary">↑↓</span>
        ...
        {mobileMenuOpen && (
          <>
            ...
            <motion.aside 
              ...
              className="fixed top-0 bottom-0 left-0 w-[280px] bg-navy-950 border-r border-white/5 z-[50] flex flex-col"
            >
